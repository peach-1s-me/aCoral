...
// {
//     return (void *)((acoral_res_t *)((acoral_char *)acoral_get_res(pool_ctrl)+sizeof(acoral_res_t)));
// }

// void acoral_free_obj(void *obj)
// {
//     acoral_release_res((acoral_res_t *)((acoral_char *)obj-sizeof(acoral_res_t)));
// }
